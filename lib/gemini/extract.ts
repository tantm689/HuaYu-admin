...
3. "grammarPoints": mỗi điểm ngữ pháp gồm tiêu đề và các đề mục giải thích ("sections"), mỗi đề mục có ví dụ minh hoạ đánh số RIÊNG của chính nó. TUYỆT ĐỐI KHÔNG trích xuất phần luyện tập/bài tập hỏi-đáp (練習/Luyện tập) của ngữ pháp.
   ...
   QUAN TRỌNG về đề mục tự chia thành nhiều ý đánh số (1. 2. 3...), ĐẶC BIỆT LÀ đề mục "Cách dùng": đây là lỗi rất hay gặp — PHẢI làm theo đúng thuật toán sau, KHÔNG suy luận thêm.
   BƯỚC 1: Đếm xem trong đề mục này, dải ví dụ đánh số trong ngoặc đơn — (1)(2)(3)(4)... — xuất hiện LẶP LẠI TỪ SỐ (1) BAO NHIÊU LẦN (mỗi lần lặp lại nghĩa là số thứ tự ví dụ quay lại (1) sau khi đã đi tới một số lớn hơn). Ví dụ: nếu trang có (1)(2)(3)(4) rồi lại (1)(2)(3)(4) một lần nữa ở dưới, đó là dải số LẶP LẠI 2 LẦN.
   BƯỚC 2: Đếm xem đề mục này có bao nhiêu ý đánh số kiểu "1. ... 2. ... " (số có dấu chấm, đứng đầu dòng, là ý giải thích — KHÁC với "(1)(2)" là số ví dụ).
   BƯỚC 3: Nếu số lần dải ví dụ LẶP LẠI ở BƯỚC 1 bằng đúng số ý đánh số ở BƯỚC 2 (ví dụ: 2 ý đánh số "1." và "2.", và dải (1)(2)(3)(4) xuất hiện đúng 2 lần): đây LUÔN LUÔN là trường hợp phải tách "items" — BẤT KỂ nội dung ví dụ ở 2 lần lặp lại đó trông có vẻ khác biệt hay tương tự nhau. PHẢI tách mỗi ý đánh số thành MỘT phần tử trong mảng "items" của đề mục đó, với "label" là số thứ tự ý (ví dụ "1", "2"), "content" là nội dung giải thích riêng của ý đó, "examples" là ĐÚNG các ví dụ trong lần lặp lại dải số đi ngay sau ý đó (ví dụ ý "1." lấy lần lặp lại (1)(2)(3)(4) thứ NHẤT, ý "2." lấy lần lặp lại (1)(2)(3)(4) thứ HAI) — để trống "content" và "examples" ở cấp đề mục cha khi đã dùng "items". TUYỆT ĐỐI KHÔNG gộp 2 lần lặp lại đó thành một mảng "examples" duy nhất ở cấp đề mục cha.
   - CHỈ khi dải ví dụ (1)(2)(3)... KHÔNG lặp lại (chỉ xuất hiện đúng 1 lần cho toàn bộ đề mục, dùng chung cho mọi ý đánh số "1." "2."): giữ nguyên số thứ tự ý ở đầu mỗi đoạn trong "content" và xuống dòng (\\n\\n) rõ ràng giữa các ý, "examples" ở cấp đề mục cha là dải số đó, và để mảng "items" rỗng.
