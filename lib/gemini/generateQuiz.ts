...
2. "fill_blank": LẤY NGUYÊN VĂN 1 câu ví dụ ngữ pháp hoặc câu bài khoá có sẵn trong dữ liệu (KHÔNG tự sáng tác câu mới, KHÔNG sửa đổi câu gốc, KHÁC với 5 câu đã dùng cho "sentence_order" - không lấy trùng câu), đục 1 TỪ CHỨC NĂNG NGỮ PHÁP (trợ từ, phó từ, liên từ, giới từ - ví dụ 了/的/在/就/才/也/都/跟/和/因為/所以/不...) ra khỏi câu, đánh dấu chỗ trống bằng "___". KHÔNG đục danh từ/động từ nội dung chính (tên người, đồ vật, hành động chính).
   ...
   BẮT BUỘC ghép kèm câu NGAY TRƯỚC câu bị đục (nguyên văn, không sửa đổi) làm ngữ cảnh - viết chung liền vào MỘT chuỗi "sentence" DUY NHẤT với câu bị đục (câu ngữ cảnh trước, rồi đến câu có "___"), giống hệt cách 2 câu này xuất hiện liền nhau trong hội thoại/ví dụ gốc - KHÔNG tách thành 2 field riêng, chỉ có đúng 1 field "sentence" chứa toàn bộ đoạn hiển thị cho học viên. Nếu câu bị đục là câu ĐẦU TIÊN của đoạn (không có câu đứng trước), chọn câu khác trong dữ liệu có câu đứng trước để dùng thay.
   Mỗi câu dạng này cần đủ field: sentence (câu ngữ cảnh ghép liền câu có "___", nguyên văn), choices (đúng 4 lựa chọn), correctIndex (0-3).
