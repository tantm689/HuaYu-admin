...
const validSample = {
  ...
  vocabulary: [{ order: 19, category: 'Cụm từ', wordZh: '歡迎', pinyin: 'huānyíng', meaningVi: 'hoan nghênh, chào mừng' }],
  grammarPoints: [{
...
describe('ExtractionResultSchema', () => {
  ...
  it('defaults missing optional pinyin/translation fields to null instead of failing', () => {
    const sparse = {
      ...validSample,
      vocabulary: [{ order: 1, category: null, wordZh: '你好', pinyin: null, meaningVi: null }],
    }
